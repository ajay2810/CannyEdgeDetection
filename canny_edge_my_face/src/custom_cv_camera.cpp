...
*
*********************************************************************/
/** This node captures video streaming from the laptop camera using OpenCV Library,
 *  as the image could be used as a sensors_msgs/Image message on ROS
 *  the cv_bridge library was used to transform an OpenCV image to a ROS one,
 *  finally the ROS image is published (using image_transport library) so
...
int main(int argc, char** argv)
{
  ...
  cv::Mat img;  // OpenCV image variable
